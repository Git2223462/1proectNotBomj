            ...
            <div class="page-about" style="display: none;">
                <div class="card card-style shadow-xl">
                    <div class="content">
						...
						<p class="mb-1"> target="Игра началась как эксперимент,старший брат проекта это Bamboo tap, который не набрал особой популярности.</p>
						<p class="mb-1">это игра которая может дать заработать многим людям,как она станет популярной,наша команда раздаст токены "violet token" .</p>
						<p class="mb-1">Следите за обновлениями и новостями проекта в Telegram-канале:Bamboo. Узнавайте первыми о новых функциях, акциях и событиях, а также делитесь своими успехами и впечатлениями с другими участниками сообщества.</p>
                    </div>
                </div>
            </div>
